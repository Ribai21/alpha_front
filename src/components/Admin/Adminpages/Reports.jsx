...
const Reports = () => {
  ...
  return (
    <div className="space-y-6 w-full h-screen overflow-y-auto p-6 bg-gray-700/20">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <h1 className="text-4xl font-bold stroke-text">Analytics</h1>
      ...
      <div className="grid grid-cols-1  md:grid-cols-3 gap-5">
        <div className="stat-card bg-white flex items-center justify-start p-3 rounded-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        <div className="chart-container bg-white  p-3 rounded">
